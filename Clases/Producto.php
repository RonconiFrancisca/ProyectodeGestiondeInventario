...
class Producto {
    ...
    public static function subirProducto($bd, $codigo, $nombre, $descripcion, $precio, $id_marca, $id_categoria) {
        $sql = "INSERT INTO producto (codigo, nombre, descripcion, precio, id_marca, id_categoria)
    ...
    public static function editarProducto($bd, $id_producto, $codigo_nuevo, $nombre_nuevo, $descripcion_nuevo, $precio_nuevo, $id_marca_nueva, $id_categoria_nueva) {
        $sql = "UPDATE producto 
                SET codigo = :codigo, nombre = :nombre, descripcion = :descripcion, 
                    precio = :precio, id_marca = :id_marca, id_categoria = :id_categoria
