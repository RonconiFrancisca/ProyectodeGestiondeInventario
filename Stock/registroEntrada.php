...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($codigo_producto && $cantidad) {
        $entrada = new Stock($codigo_producto, $cantidad);
        $entrada->registrarEntrada($bd);

        $movimiento = new Movimiento($codigo_producto, $cantidad, true, $id_usuario, $id_proveedor);
        $movimiento->subirMovimiento($bd);

        $mensaje = "Entrada registrada correctamente por el usuario: " . $nombre_completo;
    } else {
...
<body>
        <div class="volverinicio">
                <a href="../inicio/paginaInicio.php">Volver a Inicio</a></div>
        <div class="main-content">
        <div class="form-box">
            <p>Registrar Entrada de Stock</p>
            <?php
                if ($mensaje != '') {
                    echo "<p>$mensaje</p>";
                }
        ...
        <form action="registroEntrada.php" method="post">
            ...
            <label for="cantidad">Cantidad ingresada:</label><br>
