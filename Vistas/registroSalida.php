...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    if(isset($_POST['crear_guardar'])){
        ...
        Movimiento::subirMovimiento($bd, $codigo, $cantidad, false); 
...
$salidas = Movimiento::obtenerMovimientosPorTipo($bd, false); 
?>
...
<head>
    ...
    <link rel="stylesheet" href="../CSS/registrarSalida.css">
</head>
<body>
            ...
            <div class="contenedor-acciones">
                <div class="acciones">
                    <div class="accion-box">
                        <button type="button" class="crear" onclick="abrirVentanaCrear()">Registrar Salida</button>
                    </div>
                </div>
            </div>
            <table>
    ...
    <div id="ventanaCrear" class="ventana">
        <div class="ventana_contenido">
            ...
            <form method="post" action="registroSalida.php">
                ...
                <input type="number" name="cantidad" placeholder="Cantidad de salida" min="1" required>
...
<script src="../JS/registrarSalida.js"></script>
</body>
</html>